    ...
    <div className="min-h-screen bg-amber-50 text-gray-900 font-sans overflow-x-hidden">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 -mt-20 grid md:grid-cols-3 gap-6 pb-24">
        {courses.map((course, i) => (
          ...
          >
            <div className="h-40 rounded-xl mb-5 bg-gradient-to-br from-orange-100 to-amber-100 border border-gray-100" />
            <span className="text-xs text-orange-500 uppercase tracking-wide font-medium">{course.level}</span>
            <h3 className="font-semibold text-lg mt-1 text-gray-900 group-hover:text-orange-600 transition">{course.title}</h3>
